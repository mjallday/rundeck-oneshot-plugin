...
/*
* OneShotNodeStepPlugin.java
* 
* User: Greg Schueler <a href="mailto:greg@dtosolutions.com">greg@dtosolutions.com</a>
* Created: 11/6/12 11:48 AM
* 
*/
package com.dtolabs.rundeck.plugin.oneshot;
...
/**
 * OneShotNodeStepPlugin demonstrates a basic {@link com.dtolabs.rundeck.plugins.step.NodeStepPlugin}, it extends the
 ...
 */
@Plugin(name = OneShotNodeStepPlugin.SERVICE_PROVIDER_NAME, service = ServiceNameConstants.WorkflowNodeStep)
public class OneShotNodeStepPlugin implements NodeStepPlugin, DescriptionBuilder.Collaborator {
    /**
     * Define a name used to identify your plugin. It is a good idea to use a fully qualified package-style name.
     */
    public static final String SERVICE_PROVIDER_NAME = "com.dtolabs.rundeck.plugin.example.OneShotNodeStepPlugin";
